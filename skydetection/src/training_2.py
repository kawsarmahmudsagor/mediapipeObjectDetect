...
# Paths
# ----------------------------
train_dataset_path = "/home/sagor/Projects/mediapipeObjectDetect/skydetection/src/Sky-detection-4/train"
validation_dataset_path = "/home/sagor/Projects/mediapipeObjectDetect/skydetection/src/Sky-detection-4/valid"
export_base_dir = "sky_detection_model_1"
...
# ----------------------------
hyperparams_list = [
    {"batch_size":8, "epochs": 200, "learning_rate": 0.03,},
]

spec = object_detector.SupportedModels.MOBILENET_MULTI_AVG_I384
mobilenet_model = "MOBILENET_MULTI_AVG_I384"
...
for i, hparam_set in enumerate(hyperparams_list, start=1):
    ...
    destination = os.path.join(export_base_dir, f"skyDetection{i}.tflite")
    shutil.copy(tflite_model_path, destination)
    print(f"✅ Model version {i} exported as {destination}")


    OUTPUT_DIR = "/home/sagor/Projects/mediapipeObjectDetect/skydetection/src/sky_detection_model_1"
    ...
    quantized_model_path = os.path.join(
        OUTPUT_DIR,
        f"skyDetection_v{i}_fp16.tflite"
    )
